---
title: "MIKE analysis for Africa - Technical Report (update May 2021) without Unknowns"
author: ""
...
source("read.africa.data.update-2021.R", echo=TRUE)
...
The computer code from the [GIT hub repository](https://github.com/CITESmike2020/MIKE-GLMM) has been modified to estimate yearly PIKE trends from 2003-2020 using only the unweighted marginal mean PIKE model (MM.p.uw), which does not require elephant population abundance data at the site-year level. The pro and cons of this approach are discussed in more detail in the original technical document.  
