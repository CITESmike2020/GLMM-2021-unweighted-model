...
inputfilename <- file.path("..","Data","carcasssummarytable_withunkowns_2021-05-25.csv")

pike <- read.csv(inputfilename, header=TRUE, as.is=TRUE, strip.white=TRUE)

# Exclude  Unknowns from total no. carcasses - 25 June 2021
pike$uk[is.na(pike$uk)] <- 0 
pike$TotalNumberOfCarcasses <- pike$TotalNumberOfCarcasses - pike$uk
