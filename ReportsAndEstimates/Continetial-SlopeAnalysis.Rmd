---
title: "Continetial PIKE trend analysis"
author: "mk"
...
```{r}
load("report-africa-continental-fit_25_May_2021.Rdata") # created using save(all.fit, file="continental-fits.Rdata")
source("fitting-functions2.R")  # extraction and other functions
```

## A: Continetial PIKE trends for specfied break point year (2011)

```{r, results ='asis'}

# Set BreakPoints 
BreakPoints <- data.frame(StartYear=c(2003, 2011), EndYear= c(2011, 2020))
...
gg <- gg + ggtitle("Africa: Continetial PIKE trend analysis") + ylab("PIKE") + ylim(0,1)
gg
...
## B: Last five years continetial trend 
